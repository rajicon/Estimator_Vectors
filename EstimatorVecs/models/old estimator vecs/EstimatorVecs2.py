...
try:
    ...
    from EstimatorVecs.models.EstimatorVecs_inner2 import train_batch_sg, train_batch_cbow , train_batch_sg2 #ccv_inner does not exist yet
    from EstimatorVecs.models.EstimatorVecs_inner2 import score_sentence_sg, score_sentence_cbow
    from EstimatorVecs.models.EstimatorVecs_inner2 import FAST_VERSION, MAX_WORDS_IN_BATCH
...
class EstimatorVecs2(BaseWordEmbeddingsModel):
    ...
    def __init__(self, sentences=None, size=100, alpha=0.025, window=5, min_count=5,
        ...
        #self.cc = self.wv  #context clues  #wv, syn0  NOTE: this is now being changed to syn3cc, which is a trainable like syn1neg and syn2sub
        ...
        super(EstimatorVecs2, self).__init__(
        ...
        self.cc = copy.deepcopy(self.wv)
        self.cc.vectors = self.trainables.syn3cc
    ...
    def _do_train_job(self, sentences, alpha, inits):
        ...
        if self.sg:
            ...
            if self.pairs == 0 or self.pairs == 5 or self.pairs == 6:
                ...
                tally += train_batch_sg(self, sentences, alpha, work, word_work, neu1, sub_neu, self.compute_loss,
                                    self.context_size, self.cc_sampling, self.pairs)
        else:
    ...
    def train(self, sentences, total_examples=None, total_words=None,
        ...
        """
        #not changed besides EstimatorVecs2 instead of Word2Vec, but I may need to look into this more
        return super(EstimatorVecs2, self).train(
    ...
    def save(self, *args, **kwargs):
        ...
        super(EstimatorVecs2, self).save(*args, **kwargs)
    ...
    def load(cls, *args, **kwargs):
        ...
        """
        try:
            return super(EstimatorVecs2, cls).load(*args, **kwargs)
...
class Word2VecVocab(utils.SaveLoad):
    ...
    def prepare_vocab(self, hs, negative, wv, sub, subword_type, update=False, keep_raw_vocab=False, trim_rule=None,
        ...
        if subword_type == 'seg':
            ...
            subword_breakdown, subword_inds, index_subword_breakdown, padding_number = produce_subword_dict(wv.vocab, 3, 5, min_freq=3)
...
class Word2VecTrainables(utils.SaveLoad):
    ...
    def reset_weights(self, hs, negative, wv, sub):
        ...
        if negative:
            ...
            #----------------------------------------------------------------------------------------------------
            self.syn3cc = empty((len(wv.vocab), wv.vector_size), dtype=REAL)
            for i in xrange(len(wv.vocab)):
                self.syn3cc[i] = self.seeded_vector(wv.index2word[i] + str(self.seed), wv.vector_size)
