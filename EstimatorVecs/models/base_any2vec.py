...
class BaseWordEmbeddingsModel(BaseAny2VecModel):
    ...
    def build_vocab(self, sentences, update=False, progress_per=10000, keep_raw_vocab=False, trim_rule=None, **kwargs):
        ...
        report_values = self.vocabulary.prepare_vocab(
            self.hs, self.negative, self.wv, self.sub, self.subword_type, update=update, keep_raw_vocab=keep_raw_vocab,
        ...
        self.trainables.prepare_weights(self.hs, self.negative, self.wv, self.sub, update=update, vocabulary=self.vocabulary)
