...
in the original Google's word2vec C format as a KeyedVectors instance::
  ...
  >>> from EstimatorVecs.models import KeyedVectors
...
from EstimatorVecs.corpora.dictionary import Dictionary
from six import string_types, integer_types
from six.moves import xrange, zip
from scipy import sparse, stats
from EstimatorVecs.utils import deprecated
from EstimatorVecs.models.utils_any2vec import _save_word2vec_format, _load_word2vec_format, _compute_ngrams, _ft_hash
...
class WordEmbeddingsKeyedVectors(BaseKeyedVectors):
    ...
    def save(self, *args, **kwargs):
        ...
        :func:`~EstimatorVecs.models.*2vec.*2VecKeyedVectors.load` which supports
    ...
    def similarity_matrix(self, dictionary, tfidf=None, threshold=0.0, exponent=2.0, nonzero_limit=100, dtype=REAL):
        ...
        Parameters
        ----------
        dictionary : :class:`~EstimatorVecs.corpora.dictionary.Dictionary`
        ...
        tfidf : :class:`EstimatorVecs.models.tfidfmodel.TfidfModel`, optional
        ...
        See Also
        --------
        :func:`EstimatorVecs.matutils.softcossim`
            The Soft Cosine Measure.
        :class:`EstimatorVecs.similarities.docsim.SoftCosineSimilarity`
...
class Word2VecKeyedVectors(WordEmbeddingsKeyedVectors):
    ...
    def save_word2vec_format(self, fname, fvocab=None, binary=False, total_vec=None):
        ...
        """
        # from EstimatorVecs.models.word2vec import save_word2vec_format
    ...
    def load_word2vec_format(cls, fname, fvocab=None, binary=False, encoding='utf8', unicode_errors='strict',
        ...
        Returns
        -------
        :obj: `~EstimatorVecs.models.word2vec.Wod2Vec`
            Returns the loaded model as an instance of :class: `~EstimatorVecs.models.word2vec.Wod2Vec`.

        """
        # from EstimatorVecs.models.word2vec import load_word2vec_format
...
class Doc2VecKeyedVectors(BaseKeyedVectors):
    ...
    def save(self, *args, **kwargs):
        """Saves the keyedvectors. This saved model can be loaded again using
        :func:`~EstimatorVecs.models.doc2vec.Doc2VecKeyedVectors.load` which supports
    ...
    def similarity_unseen_docs(self, model, doc_words1, doc_words2, alpha=0.1, min_alpha=0.0001, steps=5):
        ...
        Parameters
        ----------
        model : :obj: `~EstimatorVecs.models.doc2vec.Doc2Vec`
...
class FastTextKeyedVectors(WordEmbeddingsKeyedVectors):
    ...
    def save(self, *args, **kwargs):
        """Saves the keyedvectors. This saved model can be loaded again using
        :func:`~EstimatorVecs.models.fasttext.FastTextKeyedVectors.load` which supports
    ...
    def word_vec(self, word, use_norm=False):
        ...
        if word in self.vocab:
            ...
            # from EstimatorVecs.models.fasttext import compute_ngrams
