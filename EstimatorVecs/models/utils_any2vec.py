...
try:
    from EstimatorVecs.models._utils_any2vec import ft_hash as _ft_hash, compute_ngrams as _compute_ngrams
except ImportError:
    FAST_VERSION = -1
...
def _load_word2vec_format(cls, fname, fvocab=None, binary=False, encoding='utf8', unicode_errors='strict',
    ...
    """
    from EstimatorVecs.models.keyedvectors import Vocab
    counts = None
    if fvocab is not None:
