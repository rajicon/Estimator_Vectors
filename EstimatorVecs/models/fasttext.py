...
from EstimatorVecs.models.word2vec import Word2VecVocab, Word2VecTrainables, train_sg_pair, train_cbow_pair
from EstimatorVecs.models.keyedvectors import Vocab, FastTextKeyedVectors
from EstimatorVecs.models.base_any2vec import BaseWordEmbeddingsModel
from EstimatorVecs.models.utils_any2vec import _compute_ngrams, _ft_hash

from EstimatorVecs.utils import deprecated, call_on_class_only
from EstimatorVecs import utils

logger = logging.getLogger(__name__)

try:
    from EstimatorVecs.models.fasttext_inner import train_batch_sg, train_batch_cbow
    from EstimatorVecs.models.fasttext_inner import FAST_VERSION, MAX_WORDS_IN_BATCH
    ...
    def train_batch_sg(model, sentences, alpha, work=None, neu1=None):
        ...
        for sentence in sentences:
            ...
            for pos, word in enumerate(word_vocabs):
                ...
                print('---------------')
                for ngram_ind in subwords_indices:
                    print(ngram_ind)
                print('stop'+9)
...
class FastText(BaseWordEmbeddingsModel):
    ...
    def load(cls, *args, **kwargs):
        ...
        try:
            ...
            from EstimatorVecs.models.deprecated.fasttext import load_old_fasttext
